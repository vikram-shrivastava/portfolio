...
const Hero = ({ setHeroInView }) => {
  ...
  const coreSkills = [
    { icon: <FaReact />, name: "Frontend (React / Next.js)" },
    { icon: <FaNodeJs />, name: "Backend (Node.js / APIs)" },
    { icon: <FaDatabase />, name: "Databases (SQL / NoSQL)" },
    { icon: <FaProjectDiagram />, name: "GenAI (LangChain / LangGraph)" },
  ];
  ...
  return (
    <section
      ref={ref}
      id="home"
      className={`relative min-h-screen flex items-center justify-center px-6 pt-20 overflow-hidden ${isDarkMode ? "bg-gray-950 text-white" : "bg-gray-50 text-gray-900"
        }`}
    >
